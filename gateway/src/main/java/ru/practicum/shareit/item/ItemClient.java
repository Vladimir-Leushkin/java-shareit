...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(GatewayItemDto itemDto, Long userId) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> patchItem(Long userId, GatewayItemDto itemDto) {
    ...
    public ResponseEntity<Object> addComment(Long itemId, Long userId, GatewayCommentDto commentDto) {
