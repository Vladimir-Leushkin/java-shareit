...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllByBooker(long userId, String stateParam, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> patchBooking(Long bookingId, Boolean approved, Long ownerId) {
