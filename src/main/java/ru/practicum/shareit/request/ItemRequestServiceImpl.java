...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Override
    public Page<ItemRequest> findAllRequests(Long userId, PageRequest pageRequest) {
        User user = userService.findUserById(userId);
        Page<ItemRequest> itemRequests = itemRequestRepository.findAllByRequestorIdIsNotOrderByCreatedDesc(userId, pageRequest);
